...
<title>NexusShop — Yellow E-Commerce</title>
...
.cat-card {
    ...
    text-align: center;
    cursor: pointer;
    box-shadow: 0 8px 20px rgba(95, 71, 0, .08);
    transition: .2s;
}

.cat-card:hover {
    transform: translateY(-6px);
    box-shadow: 0 20px 40px rgba(255, 193, 7, .25);
}
...
<header>
    ...
    <div id="mobileMenu" style="display:none;background:var(--surface);padding:15px">
        <div class="container">
            <a href="#">Home</a><br><br>
...
<section class="section container" id="categories">
    <div class="title">
        ...
        <p class="muted">Browse our popular categories.</p>
    </div>
...
<section class="section container" id="products">
    <div class="title">
        ...
        <p class="muted">Popular products selected for you.</p>
    </div>
...
<section class="section container" id="deals">
    ...
    <div class="title">
        <h2>Flash Sale</h2>
        <p class="muted">Limited-time offer.</p>
    </div>
...
<section class="section container">
    ...
    <div class="newsletter">
        ...
        <div id="newsletterMsg" style="margin-top:10px"></div>
    </div>
</section>
